...
import { createBrandAction } from "@/actions/taxonomies";
...
export default function BrandForm() {
    ...
    return (
        <form ref={formRef} action={formAction} className="bg-white p-6 rounded-xl border border-industrial-200 shadow-sm flex flex-col md:flex-row gap-4 items-end relative">
            <div className="flex-1 w-full space-y-2">
                <label className="text-sm font-bold text-industrial-800 uppercase tracking-widest">Nova Montadora/Marca</label>
                <input
                    required
                    type="text"
                    name="name"
